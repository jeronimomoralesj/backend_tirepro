...
- Si la solicitud no tiene sentido: {"impossible":true,"reason":"<explicacion>"}
- ${currentBlocks ? `BLOQUES ACTUALES (agrega nuevos sin eliminar estos):\n${JSON.stringify(currentBlocks)}` : ''}
